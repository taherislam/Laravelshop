...
@section('content')
 ...
 @foreach($product_by_manufacture_info as $v_manufacture_by_product) 
    <div class="col-sm-4">
        <div class="product-image-wrapper">
            <div class="single-products">
                    <div class="productinfo text-center">
                       <img src="{{URL::to($v_manufacture_by_product->product_image)}}" alt="" style="width: 268px; height: 249px" />
