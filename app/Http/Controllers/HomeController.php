...
class HomeController extends Controller
{
    public function index(){
    	...
    	$manage_manage_product=view('pages.home_content')
   					->with('all_publish_product_info', $all_publish_product);

   			return view('layout')
   					->with('pages.home_content', $manage_manage_product);
    ...
    public function show_product_by_category($category_id){
      ...
      $manage_product_by_category=view('pages.category_by_product')
            ->with('product_by_category_info', $product_by_category);
    ...
    public function show_product_by_manufacture($manufacture_id){
      ...
      $manage_product_by_manufacture=view('pages.manufacture_by_product')
            ->with('product_by_manufacture_info', $product_by_manufacture);
